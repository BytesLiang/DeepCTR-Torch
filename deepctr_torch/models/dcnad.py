...
class DCNAD(BaseModel):
    ...
    def __init__(self, linear_feature_columns, dnn_feature_columns, cross_num=2, cross_parameterization='vector',
                 dense_embedding="auto_dis", dense_embedding_dim=4, dnn_hidden_units=(128, 128), l2_reg_linear=0.00001,
        ...
        super(DCNAD, self).__init__(linear_feature_columns=linear_feature_columns,
        ...
        if self.dense_embedding == "auto_dis":
            self.auto_dis_layer = AutoDisLayer(13, dense_embedding_dim, H=20, alpha=0.5, tau=0.8)
        self.dnn_hidden_units = dnn_hidden_units
        self.cross_num = cross_num
        input_dim = 13*dense_embedding_dim+26*4
